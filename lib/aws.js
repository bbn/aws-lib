...
var genericAWSClient = function(obj) {
  ...
  obj.sign = function (query) {
	...
	// would be nice if the above were more complete. we're just patching holes!
	// from http://docs.amazonwebservices.com/AWSSimpleQueueService/2008-01-01/SQSDeveloperGuide/:
